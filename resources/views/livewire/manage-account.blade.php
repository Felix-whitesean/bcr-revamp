...
<div class="parent z-[111] flex gap-2 rounded-sm relative">
    ...
    <button class="px-4 py-2 border-[2px] border-black hover:bg-[var(--white-75)] self-center rounded-md flex"><i class="fi fi-rr-globe mr-4 self-center"></i><span class="self-center">Community</span></button>
